...
const ACTION_DOCS = Object.freeze({
  windows: {
    category: 'scope',
    summary: 'List all Chrome windows by default; pass includeAll=false with an explicit group to limit the result.',
    cli: ['windows'],
  ...
  tabs: {
    category: 'scope',
    summary: 'List all Chrome tabs by default; pass includeAll=false with an explicit group to limit the result.',
    cli: ['tabs'],
  ...
  workspace: {
    category: 'scope',
    summary: 'Show local workspace defaults, policy mode, and group counts.',
    cli: ['workspace'],
    mcp: ['chrome_bridge_workspace'],
  },
  setWorkspace: {
    category: 'scope',
    summary: 'Set local workspace group title, color, and open/scoped/strict policy defaults.',
    cli: ['set-workspace'],
  ...
  clearWorkspace: {
    category: 'scope',
    summary: 'Clear local workspace defaults and return to the default open policy.',
    cli: ['clear-workspace'],
  ...
  ensureTab: {
    category: 'navigation',
    summary: 'Create or recover the active Chrome work tab; explicit scoped policies still use a dedicated group.',
    cli: ['ensure-tab'],
    mcp: ['chrome_bridge_ensure_tab'],
  },
  adoptTab: {
    category: 'navigation',
    summary: 'Adopt an already-open Chrome tab into an explicit scoped bridge group.',
    cli: ['adopt-tab'],
  ...
  open: {
    category: 'navigation',
    summary: 'Open a URL in the active Chrome tab or a new tab; explicit scoped policies use the bridge group.',
    cli: ['open'],
    mcp: ['chrome_bridge_open'],
  },
  activateTab: {
    category: 'navigation',
    summary: 'Activate any Chrome tab and optionally focus its window.',
    cli: ['activate'],
    mcp: ['chrome_bridge_activate_tab'],
  },
  closeTab: {
    category: 'navigation',
    summary: 'Close one Chrome tab.',
    cli: ['close-tab'],
